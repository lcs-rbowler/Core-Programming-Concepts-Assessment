...
let temperatureInCelcius : Double = 20
let temperatureInFarenheit = temperatureInCelcius * 9 / 5 + 32
print("A temperature in degrees Celsius of \(temperatureInCelcius) is equal to \(temperatureInFarenheit) in degrees Fahrenheit.")
